...
<?php 
    ...
    $directory = $query -> readDirectory($id);
    if($directory){
    ...
    <div class="container">
        ...
        <div class="container">
            ...
            <form method="POST" action="receivedData.php" enctype="multipart/form-data" class ="form">
                ...
                <input type="hidden" name="id_directorio" value="<?php echo $id; ?>" id="nombre" class="form-control bg-secondary text-white text-center">
                ...
                <div class="card card-container">
                    <div class="center-input input-group">
                        ...
                        <input id="text" type="text" name="url" class="form-control" required value="<?php echo $url; ?>" aria-label="Username" aria-describedby="basic-addon1">
                        <span class="icon-left"><i class="zmdi zmdi-check"></i></span>
                        <span class="msj"></span>
                    </div>
                </div>
                <div class="card card-container">
                    <div class="center-input input-group">
                        ...
                        <input id="text" type="text" name="estado" class="form-control" required value="<?php echo $estado; ?>" aria-label="Username" aria-describedby="basic-addon1">
                        <span class="icon-left"><i class="zmdi zmdi-check"></i></span>
                        <span class="msj"></span>
                    </div>
                </div>
                <div class="card card-container">
                    <div class="center-input input-group">
                        ...
                        <input id="text" type="text" name="carrera" class="form-control" required value="<?php echo $carrera; ?>" aria-label="Username" aria-describedby="basic-addon1">
                        <span class="icon-left"><i class="zmdi zmdi-check"></i></span>
                        <span class="msj"></span>
                    </div>
                </div>
                <div class="card card-container">
                    <div class="center-input input-group">
                        ...
                        <input id="text" type="text" name="email" class="form-control" required value="<?php echo $email; ?>" aria-label="Username" aria-describedby="basic-addon1">
                        <span class="icon-left"><i class="zmdi zmdi-check"></i></span>
                        <span class="msj"></span>
                    </div>
                </div>
                <div class="card card-container">
                    <div class="center-input input-group">
                        ...
                        <input id="text" type="text" name="telefono" class="form-control" required value="<?php echo $telefono; ?>" aria-label="Username" aria-describedby="basic-addon1">
                        <span class="icon-left"><i class="zmdi zmdi-check"></i></span>
                        <span class="msj"></span>
                    </div>
                </div>
